...
class FacilityDonationsTable(tables.Table):
    ...
    class Meta:
        ...
        empty_text = 'No donations have been recorded yet.'
...
class FaciltyRequestsTable(tables.Table):
    ...
    class Meta:
        ...
        exclude = ('phone',)
        empty_text = 'No requests have been made yet.'
...
class BloodUnitsTable(tables.Table):
    ...
    class Meta:
        ...
        empty_text = 'No blood units have been added to the inventory.'
...
class DonorsTable(tables.Table):
    ...
    class Meta:
        ...
        empty_text = 'No donors are available at the moment.'
